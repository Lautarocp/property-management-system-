...
async function main() {
  ...
  await Promise.all([
    prisma.apartment.upsert({ where: { complexId_number: { complexId: complex1.id, number: '1A' } }, update: {}, create: { id: 'apt-1a', number: '1A', floor: 1, status: 'OCCUPIED', complexId: complex1.id } }),
    prisma.apartment.upsert({ where: { complexId_number: { complexId: complex1.id, number: '1B' } }, update: {}, create: { id: 'apt-1b', number: '1B', floor: 1, status: 'OCCUPIED', complexId: complex1.id } }),
    prisma.apartment.upsert({ where: { complexId_number: { complexId: complex1.id, number: '2A' } }, update: {}, create: { id: 'apt-2a', number: '2A', floor: 2, status: 'AVAILABLE', complexId: complex1.id } }),
    prisma.apartment.upsert({ where: { complexId_number: { complexId: complex1.id, number: '2B' } }, update: {}, create: { id: 'apt-2b', number: '2B', floor: 2, status: 'OCCUPIED', complexId: complex1.id } }),
    prisma.apartment.upsert({ where: { complexId_number: { complexId: complex1.id, number: '3A' } }, update: {}, create: { id: 'apt-3a', number: '3A', floor: 3, status: 'MAINTENANCE', complexId: complex1.id } }),
    prisma.apartment.upsert({ where: { complexId_number: { complexId: complex1.id, number: '3B' } }, update: {}, create: { id: 'apt-3b', number: '3B', floor: 3, status: 'AVAILABLE', complexId: complex1.id } }),
  ]);

  // ─── Apartments — Complex 2 ───────────────────────────────────────────────
  await Promise.all([
    prisma.apartment.upsert({ where: { complexId_number: { complexId: complex2.id, number: '101' } }, update: {}, create: { id: 'apt-101', number: '101', floor: 1, status: 'OCCUPIED', complexId: complex2.id } }),
    prisma.apartment.upsert({ where: { complexId_number: { complexId: complex2.id, number: '201' } }, update: {}, create: { id: 'apt-201', number: '201', floor: 2, status: 'AVAILABLE', complexId: complex2.id } }),
    prisma.apartment.upsert({ where: { complexId_number: { complexId: complex2.id, number: '301' } }, update: {}, create: { id: 'apt-301', number: '301', floor: 3, status: 'OCCUPIED', complexId: complex2.id } }),
    prisma.apartment.upsert({ where: { complexId_number: { complexId: complex2.id, number: '401' } }, update: {}, create: { id: 'apt-401', number: '401', floor: 4, status: 'AVAILABLE', complexId: complex2.id } }),
  ]);

  // ─── Apartments — Complex 3 ───────────────────────────────────────────────
  await Promise.all([
    prisma.apartment.upsert({ where: { complexId_number: { complexId: complex3.id, number: 'C1' } }, update: {}, create: { id: 'apt-c1', number: 'C1', floor: 1, status: 'OCCUPIED', complexId: complex3.id } }),
    prisma.apartment.upsert({ where: { complexId_number: { complexId: complex3.id, number: 'C2' } }, update: {}, create: { id: 'apt-c2', number: 'C2', floor: 1, status: 'AVAILABLE', complexId: complex3.id } }),
    prisma.apartment.upsert({ where: { complexId_number: { complexId: complex3.id, number: 'C3' } }, update: {}, create: { id: 'apt-c3', number: 'C3', floor: 1, status: 'OCCUPIED', complexId: complex3.id } }),
  ]);
